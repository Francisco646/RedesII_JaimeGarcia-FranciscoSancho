...
public class Client {
	...
	/**
	 * Creates an HTTP client if it does not exist, with specific configurations.
	 * 
	 * This method checks if the current HttpClient instance is null. If it is null, a new HttpClient
	 * instance is created with the following settings:
	 * - HTTP version: HTTP/2
	 * - Connect timeout: 10 seconds
	 *
	 * @throws IllegalArgumentException If an illegal argument exception occurs during HttpClient creation.
	 * @throws Exception If any unexpected error occurs during HttpClient creation.
	 */
	...
	private static void createHttpClient() {
		...
		try {
	    	...
	    	System.err.println("Unexpected error creating HTTP client: " + e.getMessage());
	    }
